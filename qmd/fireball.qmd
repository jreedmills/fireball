...
We can see that enemies with higher HP (i.e. Ogres) have a much higher probability of surviving a fireball attack than enemies with lower HP (i.e. Goblins). The other modifiers, particularly the fire resistance of the demons, also seem be significant for enemies with low-mid HP. 
